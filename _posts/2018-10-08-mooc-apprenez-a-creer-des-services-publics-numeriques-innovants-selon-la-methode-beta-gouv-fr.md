---
layout: post
title: "MOOC\_: apprenez à créer des services publics numériques innovants selon la méthode beta.gouv.fr\_!"
...
excerpt: >-
  ...
  incubateur de services numériques au sein de la **direction interministérielle
  du numérique et du système d'information et de communication de l'État
  (DINSIC)** et le **centre national de la fonction publique territoriale
  (CNFPT)**. L’objectif ? Permettre aux agents publics désireux d’innover de se
  lancer.
---
