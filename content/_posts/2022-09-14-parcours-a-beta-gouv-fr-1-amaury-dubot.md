...
Mon rôle était de déployer l’outil auprès des agents publics qui travaillent quotidiennement avec les entreprises. J’avais également des missions en lien avec mon expertise en affaires publiques, comme la gestion de la communication administrative et des relations presse. 

Ma seconde mission a commencé en octobre 2021 à [RDV-Insertion](https://www.rdv-insertion.fr/). Cet outil permet de favoriser la prise de rendez-vous des bénéficiaires du RSA sur le lieu et le créneau de leur convenance afin d’améliorer le taux de présence et de favoriser leur entrée dans des parcours d’insertion. Je travaille toujours dans cette startup en tant que chargé de déploiement. Mon rôle consiste à convaincre les conseils départementaux d’utiliser notre outil et de favoriser leur démarrage. J’anime également les cafés de l’insertion et je coordonne la rédaction de la newsletter du service public de l’insertion et de l’emploi (SPIE). 

La dernière mission sur laquelle je suis engagé est celle de [Carnet de bord](https://beta.gouv.fr/startups/carnet.de.bord.html), un service qui a pour objectif de faciliter la coordination des échanges entre acteurs·trices de l’insertion : les informations sur les usagers·gères et sur leur historique de parcours sont partagées entre tous leurs accompagnateurs·trices, permettant de construire des parcours sans couture et de respecter la logique dite du « [Dites-le-nous une fois](https://www.numerique.gouv.fr/services/guichet-dites-le-nous-une-fois/) (DLNUF) ». 
...
Je me suis renseigné sur l’écosystème de ces startups et j’ai suivi les différents processus de recrutement.
