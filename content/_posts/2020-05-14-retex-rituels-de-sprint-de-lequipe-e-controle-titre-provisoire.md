---
layout: post
title: "Le lancement de sprint : forcément interminable et douloureux ?"
...
* "Trello" : logiciel de gestion de projet/produit en ligne dont les fonctionnalités de base sont gratuites. Il permet de mettre des cartes (comme des post-its) dans des listes thématiques verticales. Il existe bien d'autres outils gratuits ou payants.
...
* un coach de Start-up d'État : un membre de l'équipe dont la mission est de nous aider à obtenir des résultats concrets auprès des usagers et surtout mesurables.
...
## Trois types de réunions d'équipe "ritualisées"
...
* le debrief quotidien (et systématique) de quelques minutes où chacun raconte ce qu'il a fait la veille, ce qu'il pense faire aujourd'hui et s'il a besoin d'aide. En visio, ça marche très bien. Ça fait un an et demi qu'on l'expérimente. Il est censée durer 10 minutes mais il arrive qu'on dépasse le chrono si un problème doit être résolu.
...
* trop longue : parfois au delà de 60 minutes ;
...
* une convergence et une prise de décision compliquées en fin d’atelier.
...
* Chacun choisit une[](https://fr.piliapp.com/facebook-symbols/) émoticône et l’ajoute à côté de son prénom.
