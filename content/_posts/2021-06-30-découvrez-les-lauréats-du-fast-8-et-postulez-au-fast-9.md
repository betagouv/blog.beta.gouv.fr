...
En avril 2021 nous avons lancé chez beta.gouv.fr, un programme de la Direction Interministérielle du Numérique, [notre huitième appel à candidatures FAST](https://blog.beta.gouv.fr/dinsic/2021/04/19/1-120-000-euros-pour-les-laureats-du-fast-7-postulez-des-maintenant-a-la-8eme-edition/). 

Parmi les candidats, **8 dossiers ont été pré-sélectionnés** par beta.gouv.fr et ont présenté leur dossier à l'oral devant le comité d’investissement.
5 lauréats ont été choisis par les membres du jury. 

Les critères de sélection pour les produits :
...
* Avoir un sponsor administratif garantissant un co-financement pour la période d'accélération du produit. 
...
### Les 5 lauréats du FAST 8 :
1. L'incubateur de la Direction Générale des Finances Publiques (DGFIP), pour assurer des missions de services publics de meilleure qualité, en continuelle amélioration.
2. [Aides Jeunes](https://mes-aides.1jeune1solution.beta.gouv.fr/), pour élargir le périmètre d'aides disponibles, améliorer le parcours, et simplifier l'accès aux aides pour les jeunes.  
3. [Archifiltre](https://archifiltre.fabrique.social.gouv.fr/), pour démultiplier le volume de données analysées et supprimées, et ainsi réduire sensiblement l'impact environnemental de nos archives.
4. [DossierFacile](https://www.dossierfacile.fr/?utm_source=betagouv), pour développer les partenariats et proposer une expérience numérique la plus complète et fluide possible aux candidats locataires.
5. [Base Adresse Locale](https://adresse.data.gouv.fr/bases-locales), pour atteindre les 5000 communes ouvertes et améliorer la qualité des données adresses alimentant le [point d'accès national](https://adresse.data.gouv.fr/).
...
![](/img/posts/2021_06_29_1200x675_fast_13sept_visuel_twitter.jpg)

# Lancement de la prochaine édition du Fast

**L'appel à candidatures de la 9ème édition est ouvert !**
...
Cliquez ici [pour en savoir plus](https://beta.gouv.fr/fast/) et/ou [postuler](https://www.demarches-simplifiees.fr/commencer/fast9) sur la session du 13 septembre.
...
En cas de questions sur le fonds et ses appels à projets, vous pouvez contacter l’équipe FAST à [fast@beta.gouv.fr](fast@beta.gouv.fr).
