...
### 1. Le programme Gamma

- - -

Pour rappel, le programme [beta.gouv.fr](https://beta.gouv.fr/), dont l’approche « startups d’État » vise à aider les ministères et autres partenaires publics à construire des services numériques simples, faciles à utiliser, et à l’impact maximal, se décompose en [4 phases](https://beta.gouv.fr/approche/) : 
* **Investigation** : validation du problème et de la possibilité d’une solution numérique ;
* **Construction** : création d’un service fonctionnel avec des premiers usagers ;
...
[Aides-territoires](https://aides-territoires.beta.gouv.fr) est le guichet unique qui permet aux acteurs des territoires de réaliser leurs projets locaux. Elle rassemble et diffuse les aides financières et d’ingénierie portées par différents porteurs de projets (Collectivités, départements, Commission Européenne, Banque des territoires, Bpifrance…) afin qu’elles soient plus facilement mobilisables par les acteurs locaux partout en France. 

Aujourd’hui, Aides-territoires représente 1410 aides disponibles, 315 porteurs d’aides et 81 thématiques de projets.
De plus, Aides-territoires a récemment mis en place [le guichet unique des aides portées par le Ministère de la Transformation et de la Fonction Publique](https://france-relance.transformation.gouv.fr) pour la transformation numérique de l'État et des territoires dans le cadre du plan de relance. Ces aides, d’un montant total de 500 millions d’euros sont directement entrées sur la plateforme et disponibles via une API.
...
[Mon-entreprise](https://mon-entreprise.fr) est la plateforme qui a pour ambition d’être l’assistant officiel des entrepreneurs. Elle met à disposition les ressources nécessaires pour développer leurs activités, du statut juridique à l'embauche, notamment au travers de questionnaires (pour choisir le statut juridique adapté à son activité par exemple) ou de simulateurs divers (pour calculer son revenu net après impôt selon son statut par exemple). Mon-entreprise fait d’ailleurs parti du réseau de l’URSSAF.
