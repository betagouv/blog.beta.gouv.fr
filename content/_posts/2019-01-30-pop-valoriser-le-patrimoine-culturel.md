...
excerpt: >-
  ...
  son lancement, elles font un premier bilan de la Startup d’État.
---
## POP, c’est quoi ?

**Jennifer** : POP, c’est rendre accessible au plus grand nombre les données culturelles du patrimoine français. Cela concerne entre autres les différents types d’œuvres conservées dans les musées décrites par l’Inventaire général ou classées au titre des monuments historiques. L’objectif est de les valoriser pour en faire un bien commun. Elle comprend deux volets : une plateforme pour les producteurs de données, et une accessible au grand public (chercheurs, passionnés, curieux, associations, étudiants, etc.).
...
**Jennifer** : Notre principale base source aujourd’hui pour les musées c’est Joconde, le catalogue collectif des musées de France. Par exemple, le Louvre n’avait plus versé de données dans cette base depuis 10 ans. Ils possèdent leur propre collection dans leur système informatique mais qui n’est pas totalement ouvert au public. En leur proposant de reverser leurs données dans POP, ce seront des milliers de notices et d’informations autour des œuvres qui seront portées au public.
