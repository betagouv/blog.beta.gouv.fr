...
---
Notre travail de fond auprès des collectivités a porté ses fruits. Nous sommes très fiers d’avoir dépassé les 100 agglomérations dont les horaires théoriques sont disponibles sur [transport.data.gouv.fr](transport.data.gouv.fr). Ces données couvrent une population de plus de 18 millions d’habitants dans quasiment toutes les grandes métropoles.
