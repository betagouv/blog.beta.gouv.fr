...
Je suis ensuite partie sur [API.gouv.fr](http://api.gouv.fr/)/[Api Particulier](https://api.gouv.fr/les-api/api-particulier)/ [Datapass](https://beta.gouv.fr/startups/datapass.html), toujours en tant que développeuse. Ces trois produits ont pour objectif d'accélérer le [Dites-le-nous une fois](https://www.numerique.gouv.fr/services/guichet-dites-le-nous-une-fois/) (DLNUF) en simplifiant les démarches des usager·e·s en développant l’usage des API par les administrations pour échanger des données sur les usager·e·s. J’ai eu l’occasion de toucher un peu à tout pendant ces quelques mois : du bizdev, du juridique, du dev. C’était passionnant. 
...
Ma façon de faire c’est vraiment : j’arrive, je commence à travailler avec l’équipe, je vois si ça fit.

Pour l’opportunité [Aidants connect](https://aidantsconnect.beta.gouv.fr/) j’en ai entendu parler car Florian Delezenne (à l’époque Product Owner de France Connect, actuellement responsable de l’incubateur) était notre contact sur [API.gouv.fr](http://api.gouv.fr/). 
